      ...
      {userInfo ? (
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm mt-3  font-semibold text-center">
            Use Card - <span className="text-green-600">4242 4242 4242 4242</span>
          </p >
        </div>
      ) : (
        <div className="flex flex-col items-center">
          ...
          {/* <p className="text-xs mt-1 text-red-500 font-semibold text-center">
            Custom login is not implemented yet.! can proceed without login for now.
          </p> */}
        </div>
      )}
    </div>
